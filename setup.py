...
setup(
    ...
    install_requires=['NumPy >= 1.6.0', 'pymc >= 2.3.6', 'pandas >= 0.12.0', 'matplotlib >= 1.0.0', 'SciPy >= 0.6.0'],
    setup_requires=['NumPy >= 1.6.0', 'pymc >= 2.3.6', 'pandas >= 0.12.0', 'matplotlib >= 1.0.0', 'SciPy >= 0.6.0']
)
