...
class TestGenerate(unittest.TestCase):
    ...
    def test_single_cond_no_subj(self):
        ...
        np.random.seed(31337)
        data = gen_rand_data(normal_like, params, samples=100)
        np.random.seed(31337)
    ...
    def test_single_cond_multi_subjs(self):
        ...
        # generate test data
        np.random.seed(31337)
        data = gen_rand_data(normal_like, params, samples=samples, subjs=subjs)
    ...
    def test_single_cond_multi_subjs_exclude(self):
        ...
        # generate test data
        np.random.seed(31337)
        data = gen_rand_data(normal_like, params, samples=samples, subjs=subjs, exclude_params=('scale',))
    ...
    def test_mulltiple_cond_no_subj(self):
        ...
        np.random.seed(31337)
        data = gen_rand_data(normal_like, params, samples=samples)
